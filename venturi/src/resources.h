...
namespace wi::Venturi
{
    ...
    {
        // application icons
        inline static Ref<Oak::Texture2D> AppLogo = nullptr;
        inline static Ref<Oak::Texture2D> MinimizeIcon = nullptr;
        inline static Ref<Oak::Texture2D> MaximizeIcon = nullptr;
        inline static Ref<Oak::Texture2D> RestoreIcon = nullptr;
        inline static Ref<Oak::Texture2D> CloseIcon = nullptr;

        inline static Ref<Oak::Texture2D> MenuIcon = nullptr;
        inline static Ref<Oak::Texture2D> ExplorerIcon = nullptr;
        inline static Ref<Oak::Texture2D> ConnectionIcon = nullptr;
        inline static Ref<Oak::Texture2D> ChartIcon = nullptr;
        inline static Ref<Oak::Texture2D> ConsoleIcon = nullptr;
        inline static Ref<Oak::Texture2D> AddPlotIcon = nullptr;
        inline static Ref<Oak::Texture2D> ExportIcon = nullptr;
        inline static Ref<Oak::Texture2D> PlusIcon = nullptr;
        inline static Ref<Oak::Texture2D> SettingsIcon = nullptr;

        inline static Ref<Oak::Texture2D> RefreshIcon = nullptr;
        inline static Ref<Oak::Texture2D> NewFileIcon = nullptr;
        inline static Ref<Oak::Texture2D> NewDirIcon = nullptr;

        inline static Ref<Oak::Texture2D> PlayIcon = nullptr;
        inline static Ref<Oak::Texture2D> PauseIcon = nullptr;
        inline static Ref<Oak::Texture2D> StopIcon = nullptr;
        inline static Ref<Oak::Texture2D> RecordIcon = nullptr;
        inline static Ref<Oak::Texture2D> RecordingIcon = nullptr;



        static void Init()
        {
            LOG_CORE_TRACE_TAG("Resources::Init", "Initializing application resources...");
            ...
            LOG_CORE_TRACE_TAG("Resources::Init", "... done");
        }
    ...
    private:
        static Ref<Oak::Texture2D>  LoadTexture(const std::filesystem::path& relativePath)
        {
            if (!Oak::FileSystem::Exists(relativePath))
            {
                LOG_FATAL_TAG("Resources::LoadTexture", "Failed to load texture {0}. The file does not exist", relativePath.string());
                return nullptr;
            }
